...
3. Although `boosted1` is the top performer among candidates in @tbl-fit-resamples2, the differences across the upper 50% of candidates are marginal at-best\
    a) If this model is "any good", then it is likely that the runner-ups are as well to very similar degrees
...
Recall that the feature selection/engineering steps *unique to this recipe* consist of the following components:
...
### Univariate EDA: Class Imbalances
